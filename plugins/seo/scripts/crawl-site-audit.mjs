...
console.log(JSON.stringify({ auditId: current.manifest.id, version: 5, pages: pages.length, deepSelected: deep.size, findings: savedFindings.findings.length, diagnostics: diagnostics.length, sitemaps: sitemapInventory.length }, null, 2));
